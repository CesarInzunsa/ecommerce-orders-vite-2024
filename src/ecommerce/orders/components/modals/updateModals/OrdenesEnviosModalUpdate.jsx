...
const OrdenesEnviosModalUpdate = ({
                                      OrdenesEnviosShowModalUpdate,
                                      setOrdenesEnviosShowModalUpdate,
                                      datosSeleccionados,
                                      fetchData,
                                      dataRow
                                  }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                //buscar el indice del documento de envios
                const indexEnvios = ordenExistente.envios.findIndex((envio) => envio.IdDomicilioOK === dataRow.IdDomicilioOK && envio.IdPaqueteriaOK === dataRow.IdPaqueteriaOK);

                ordenExistente.envios[indexEnvios] = {
    ...
    return (
        <Dialog
            open={OrdenesEnviosShowModalUpdate}
            ...
            <form onSubmit={(e) => {
                ...
                <DialogActions sx={{display: 'flex', flexDirection: 'row'}}>
                    ...
                    <LoadingButton
                        ...
                        startIcon={<CloseIcon/>}
                        variant="outlined"
                        onClick={() => setOrdenesEnviosShowModalUpdate(false)}
                    >
                        <span>CERRAR</span>
                    </LoadingButton>
                    <LoadingButton
