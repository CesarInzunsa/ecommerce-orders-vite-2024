...
const OrdenesEnviosRastreosRastreosModalUpdate = ({
                                                      OrdenesEnviosRastreosRastreosShowModalUpdate,
                                                      setOrdenesEnviosRastreosRastreosShowModalUpdate,
                                                      datosSeleccionados,
                                                      datosSecSubdoc,
                                                      fetchData,
                                                      dataRow
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                ordenExistente.envios[indexEnvios].rastreos[indexRastreo] = {
    ...
    return (
        <Dialog
            open={OrdenesEnviosRastreosRastreosShowModalUpdate}
            onClose={() => setOrdenesEnviosRastreosRastreosShowModalUpdate(false)}
            fullWidth
        >
            <form onSubmit={(e) => {
                ...
                <DialogTitle>
                    <Typography>
                        <strong>Actualizar rastreo del Envio</strong>
                    </Typography>
                </DialogTitle>
                ...
                >
                    ...
                    <LoadingButton
                        ...
                        startIcon={<CloseIcon/>}
                        variant="outlined"
                        onClick={() => setOrdenesEnviosRastreosRastreosShowModalUpdate(false)}
                    >
                        <span>CERRAR</span>
                    </LoadingButton>
...
export default OrdenesEnviosRastreosRastreosModalUpdate;
