...
const OrdenesFacturaProductosDescuentosModal = ({
                                                    OrdenesDetallesEstatusModalShowModal,
                                                    setOrdenesDetallesEstatusModalShowModal,
                                                    datosSeleccionados,
                                                    datosSecSubdoc,
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                ordenExistente.factura[indexFactura].productos[indexProductos].descuentos.push({
    ...
    return (
        <Dialog
            open={OrdenesDetallesEstatusModalShowModal}
        ...
        >
            <form onSubmit={(e) => {
                ...
                <DialogTitle>
                    <Typography>
                        <strong>Agregar Nuevo producto-Descuento a la orden</strong>
                    </Typography>
                </DialogTitle>
                ...
                >
                    ...
                    <LoadingButton
                        ...
                        variant="outlined"
                        onClick={() => {
                            setOrdenesDetallesEstatusModalShowModal(false);
...
export default OrdenesFacturaProductosDescuentosModal;