...
import {OrdenesFacturaDomicilioValues} from "../../../helpers/OrdenesFacturaDomicilioValues.jsx";
import {GetOneOrder} from "../../../services/remote/get/GetOneOrder.jsx";
import useProducts from "../../../services/remote/useProducts.jsx";

const OrdenesFacturaDomicilioModal = ({
                                          OrdenesFacturaDomicilioShowModal,
                                          setOrdenesFacturaDomicilioShowModal,
                                          datosSeleccionados,
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                console.log("datosSec", datosSecSubdocDetalles)
                ...
                for (let i = 0; i < ordenExistente.factura[index].domicilio.length; i++) {
                    //console.log("Entro")
                    ordenExistente.factura[index].domicilio[i] = {
                        IdDomicilioOK: ordenExistente.factura[index].domicilio[i].IdDomicilioOK,
                        CalleNumero: ordenExistente.factura[index].domicilio[i].CalleNumero,
                        CodPostal: ordenExistente.factura[index].domicilio[i].CodPostal,
                        Pais: ordenExistente.factura[index].domicilio[i].Pais,
                        Estado: ordenExistente.factura[index].domicilio[i].Estado,
                        Municipio: ordenExistente.factura[index].domicilio[i].Municipio,
                        Localidad: ordenExistente.factura[index].domicilio[i].Localidad,
                        Colonia: ordenExistente.factura[index].domicilio[i].Colonia,
                    };
                ...
                const FacturaDomicilioOrdenes = OrdenesFacturaDomicilioValues(values, ordenExistente, index);
                console.log("5");
                // actualizar la orden
                await UpdatePatchOneOrder(IdInstitutoOK, IdNegocioOK, IdOrdenOK, FacturaDomicilioOrdenes);
                console.log("6");
    ...
    return (
        <Dialog
            open={OrdenesFacturaDomicilioShowModal}
        ...
        >
            <form onSubmit={(e) => {
                ...
                <DialogTitle>
                    <Typography>
                        <strong>Agregar Nueva dirección a la factura</strong>
                    </Typography>
                </DialogTitle>
                ...
                >
                    ...
                    <LoadingButton
                        ...
                        variant="outlined"
                        onClick={() => {
                            setOrdenesFacturaDomicilioShowModal(false);
...
export default OrdenesFacturaDomicilioModal;