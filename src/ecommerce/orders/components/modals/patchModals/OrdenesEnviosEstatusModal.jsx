...
//HELPERS
import {OrdenesEnviosEstatusValues} from "../../../helpers/OrdenesEnviosEstatusValues.jsx";
...
const OrdenesEnviosEstatusModal = ({
                                       OrdenesEnviosEstatusShowModal,
                                       setOrdenesEnviosEstatusShowModal,
                                       datosSeleccionados,
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                for (let i = 0; i < ordenExistente.envios[index].estatus.length; i++) {
                    console.log("Entro")
                    ordenExistente.envios[index].estatus[i] = {
                        IdTipoEstatusOK: ordenExistente.envios[index].estatus[i].IdTipoEstatusOK,
                        Actual: values.Actual? "N": ordenExistente.envios[index].estatus[i].Actual,
                        Observacion: ordenExistente.envios[index].estatus[i].Observacion
                    };
                ...
                //console.log(ordenExistente);
                const EstatusOrdenes = OrdenesEnviosEstatusValues(values, ordenExistente, index);
    ...
    return (
        <Dialog
            open={OrdenesEnviosEstatusShowModal}
            onClose={() => setOrdenesEnviosEstatusShowModal(false)}
            fullWidth
        >
            <form onSubmit={(e) => {
                ...
                <DialogTitle>
                    <Typography>
                        <strong>Agregar Nuevo Estado del Envio</strong>
                    </Typography>
                </DialogTitle>
                {/* FIC: Aqui va un tipo de control por cada Propiedad de Institutos */}
                <DialogContent sx={{display: 'flex', flexDirection: 'column'}} dividers>
                    {/* FIC: Campos de captura o selección */}
                    <InputLabel htmlFor="dynamic-select-tipo-orden">Tipo de Estatus</InputLabel>
                    <Select
                ...
                >
                    ...
                    <LoadingButton
                        ...
                        startIcon={<CloseIcon/>}
                        variant="outlined"
                        onClick={() => setOrdenesEnviosEstatusShowModal(false)}
                    >
                        <span>CERRAR</span>
                    </LoadingButton>
...
export default OrdenesEnviosEstatusModal;
