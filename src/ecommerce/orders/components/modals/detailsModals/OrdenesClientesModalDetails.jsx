...
const OrdenesClientesModalUpdateDetails = ({
                                               OrdenesClientesShowModalDetails,
                                               setOrdenesClientesShowModalDetails,
                                               dataRow
                                           }) => {
    ...
    return (
        <Dialog
            open={OrdenesClientesShowModalDetails}
            onClose={() => setOrdenesClientesShowModalDetails(false)}
            fullWidth
        >
            <form onSubmit={(e) => {
                ...
                <DialogTitle>
                    <Typography>
                        <strong>Detalles -  cliente a la Orden</strong>
                    </Typography>
                </DialogTitle>
                ...
                >
                    ...
                    <LoadingButton
                        ...
                        startIcon={<CloseIcon/>}
                        variant="outlined"
                        onClick={() => setOrdenesClientesShowModalDetails(false)}
                    >
                        <span>CERRAR</span>
                    </LoadingButton>
                </DialogActions>
...
export default OrdenesClientesModalUpdateDetails;